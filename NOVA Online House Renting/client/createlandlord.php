        ...
        <main>
            ...
            <div class="row g-5 py-5">
                ...
                <div class="col-md-7 col-lg-8">
                    <h4 class="mb-3">New Landlord Account</h4>
                    <form class="needs-validation" method="POST" action="createlandlord.php" novalidate>
                        <div class="row g-3">
                            <div class="col-sm-12">
                        ...
                        <input class="w-100 btn btn-primary btn-lg" name="createlandlordsubmitbtn" type="submit" value="Create">
                        <?php
                        if(isset($_POST['createlandlordsubmitbtn'])){
                            ...
                            $PHONENUMBER = $_POST['Phonenumber'];
                                ...
                                $sql = "INSERT INTO `landlord` (`name`, `username`, `email`, `password`, `country`, `address`, `phonenumber`)
                                 VALUES (
                                 '$NAME',
                                 '$USERNAME',
                                 '$EMAIL',
                            ...
                            echo "<script>alert('A/C Created');window.location='index.php';</script>";
                                }else {
                                echo "<script>alert('A/C NOT Created !');window.location='createlandlord.php';</script>";
                            }
                            }
                        ?>
                    </form>
...
<div class="offcanvas offcanvas-end" data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1" id="signinoffcanvas"
    ...
    <div class="offcanvas-body">
        ...
        <div class="form-floating">
            <span class="h2 text-primary">Client</span>
            <br><br><br>
            <form method="POST" >
                <div class="form-floating">
                ...
                <?php
                    if (isset($_POST['submitbtn'])){
                        ...
                        if (mysqli_num_rows($query) >=1) {
                            ...
                            echo "<script>alert('Login failed');window.location='index.php?search';</script>";
                        }  
                    }
                ?>
            </form>
