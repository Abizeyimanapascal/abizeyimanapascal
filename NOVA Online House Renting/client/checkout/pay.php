    ...
    <main>
        <div class="container">
            <div class="py-5 text-center">
                ...
                <br>
                <p class="lead">
                  Below is a checkout form. Fill all required fields to confirm your purchasing details.
                </p> <br>
            </div>
                    ...
                    <form class="needs-validation" method="POST" novalidate>
                        <div class="row g-3">
                            <div class="col-sm-12">
                                ...
                                <input type="text" name="Name" class="form-control" id="name" value="<?php echo $userrow['name'] ?>" disabled>
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group has-validation">
                                    ...
                                    <input type="text" name="Username" class="form-control" id="username" value="<?php echo $userrow['username'] ?>" disabled>
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-12">
                                ...
                                <input type="email" name="Email" class="form-control" id="email" value="<?php echo $userrow['email'] ?>" disabled>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="Address" class="form-control" id="address" value="<?php echo $userrow['address'] ?>" disabled>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" name="Country" class="form-control" id="country" value="<?php echo $userrow['country'] ?>" disabled>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="State" class="form-control" id="province" value="<?php echo $userrow['state'] ?>" disabled>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-5">
                                <label for="quantity" class="form-label">Quantity (Max <b>4030 KGs</b>)</label>
                                <input type="number" name="Quantity" class="form-control" id="quantity" onkeyup="quantityfieldchange()" required>
                                <div class="invalid-feedback">
                                    Quantity required.
                                </div>
                            </div>
                        ...
                        <div class="row gy-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="" value="<?php echo $userrow['phonenumber'] ?>" disabled>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-6">
                                <label for="phonenumber" class="form-label">Re-Enter matching Phone number</label>
                        ...
                        <button name="checkoutbtn" class="w-100 btn btn-primary btn-lg" type="submit">Confirm Order</button>
                        <?php
                          if(isset($_POST['checkoutbtn'])){
                            ...
                            echo "<script>alert('Upload DONE');window.location='account.php';</script>";
                                }else {
                                echo "<script>alert('Upload FAILED !');window.location='account.php';</script>";
                            }
                            }
                        ?>
                    </form>
