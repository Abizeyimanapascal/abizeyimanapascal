...
<br><br>
        ...
        <div class="row ms-5 col-10">
                ...
                <div class="col-md-7">
                    <h4 class="mb-3">House Description</h4>
                    <form class="needs-validation" method="POST" novalidate>
                        <div class="row g-3">
                            <div class="col-md-12">
                                <p><img src="img/info.png" height="20">&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $productrow['house_description'] ?></p>
                                <p><span class="text-muted"><img src="img/home.png" height="20">&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $productrow['house_type'] ?></span></p>
                                <p><img src="img/sleeping.png" height="30">&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $productrow['num_beds'] ?> Bedrooms</p>
                                <p><img src="img/bathroom.png" height="20">&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $productrow['num_bathrooms'] ?> Bathrooms</p>
                                <p><img src="img/kitchen.png" height="30">&nbsp;&nbsp;&nbsp;&nbsp; 1 Kitchen</p>
                                <p><img src="img/location.png" height="20">&nbsp;&nbsp;&nbsp;&nbsp;<span class="text-muted"><?php echo $productrow['house_location']?></span></p>
                                <p>Was Built in <span class="text-muted h5"><?php echo $productrow['year_built']?> Year </p>
                                <p><b><?php echo $productrow['house_price'] ?> RWF /</b> Month</span></p>
                            </div>                            
                        </div>

                        <hr class="my-4">

                        <a href="form.php? house_id=<?php echo $_GET['house_id'] ?>" class="col-lg-12 link row btn btn-primary" style="text-decoration:none">Inquire
                        </a>
                    </form>
                </div>
            </div>
