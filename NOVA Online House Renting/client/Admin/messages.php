    ...
    <div class="text-center fixed-top row bg-light text-muted shadow"  style="transition:transform 3s ease-in;">
      ...
      <div class="container-fluid">
        ...
        <ul class="navbar-nav me-auto mb-2 mb-md-0 justify-content-center">              
            ...
            <li class="nav-item">
              <a class="btn btn-info py-4 ms-5" href="messages.php">Messages
...
<br><br><br>
  ...
  ================================================== -->
    ...
    <br><br><br><br>
      <!-- MAIN US ROW -->
      <div class="row">
      <div class="alert bg-info h6 row">
        ...
        ?>  
          <div class="alert alert-light text-muted row">
           <div class="col-2"><?php echo $row['commentername'] ?></div>
           <div class="col-2"><?php echo $row['commenterphone'] ?></div>
           <div class="col-7"><?php echo $row['comment'] ?></div>
           <div class="col-1">
           <a href="../../server/deletemessage.php? id=<?php echo $row['commentid'] ?>" class="link text-danger ms-2" style="text-decoration:none;" title="Delete">❌</a>
           </div>
          </div>
         <?php
         }
