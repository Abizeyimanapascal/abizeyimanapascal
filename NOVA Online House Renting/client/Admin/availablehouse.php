    ...
    <div class="text-center fixed-top row bg-light text-muted shadow"  style="transition:transform 3s ease-in;">
      ...
      <div class="container-fluid">
        ...
        <ul class="navbar-nav me-auto mb-2 mb-md-0 justify-content-center">              
            ...
            <li class="nav-item">
              <a class="btn btn-success py-4 ms-5" href="availablehouse.php">Available Houses
...
<br><br><br>
  ...
  ================================================== -->
    ...
    <br><br><br><br>
      <!-- MAIN US ROW -->
      <div class="row">
      <div class="alert bg-success h6 row">
           <div class="col-1">House ID</div>
           <div class="col-2">Type</div>
           <div class="col-2">Location</div>
           <div class="col">Upload date</div>
           <div class="col">Approval date</div>
           <div class="col-2">Owner Name</div>
