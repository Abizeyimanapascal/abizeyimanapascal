...
<body>
    ...
    <header data-bs-theme="bg-light">
        <div class="text-center sticky-top row bg-light text-muted shadow" style="transition:transform 3s ease-in;">
            <div class="col-2 h3">
              <a class="nav-link text-primary" href="index.php"><img src="img/logo.png"width="100%"></a>
            </div>
            <div class="col-8">
        ...
        <div id="myCarousel" class="carousel slide mb-6" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <img src="img/a1.jpg" alt="" style="width: 100%;height: 100%;">
                    <div class="container">
                        <div class="carousel-caption center-start">
                            <h1 class="pic1an1">We are NOVA</h1>
                            <p class="top-5 pic1an2 text-light h1">SeeIt, LoveIt, RentIt!</p>
                            <p><a class="btn btn-lg btn-primary" href="uploadhouse.php">Upload A House</a>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                <img src="img/c1.jpg" alt="" style="width: 100%;height: 100%;">
                    <div class="container">
                        <div class="carousel-caption">
                            <h1 class="pic2an1 top-5">Advanced Property Search</h1>
                            <p class=" top-5">Filters for location, price range, property type, and amenities</p>
                            <p><img src="img/communication.png" alt="" width="150"></p>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                <img src="img/a2.jpg" alt="" style="width: 100%;height: 100%;">
                    <div class="container">
                        <div class="carousel-caption text-center">
                            <h1 class="pic3an1">Guided Rental Process</h1>
                            <p class="pic3an2">users receive step-by-step support throughout</p>
                            <p><img src="img/s6.png" alt="" width="150"></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- SEARCH  ROW -->
                <div class="px-4 text-center">
                    <div class="col-lg-6 mx-auto">
                       <form action="index.php#a">
                         <div class="input-group mb-1">
                          <span class="h6 my-2">Search by sector</span> &nbsp;&nbsp;&nbsp;
                         <select name="search" class="form-control" id="pcategory">
                                <option></option>      
                            ...
                            <button type="submit" name="" class="btn border btn-primary">
                              Search
                            </button>
                         </div>
                       </form>
                ...
                <br>             
                        ...
                        $sql = "SELECT * FROM `house` WHERE `status` = 'approved' AND `house_location` LIKE '%$_GET[search]%'  ORDER BY `uploaddate` DESC";
                        $query = mysqli_query($con, $sql)or die(mysqli_error());
                        while($row = mysqli_fetch_array($query)){
                        ?>
                        <a href="hdescription.php? house_id=<?php echo $row['house_id'] ?>" class="col-sm-2 hover text-muted shadow rounded" style="width: 13rem;margin-left:0.3rem;margin-right:0.3rem;margin-top:3rem;text-decoration:none;">
                        <img src="uploads/<?php echo $row['house_image']?>" class="card-img-top" height="150px">
                        <div class="card-body">
                          <p class="card-text fw-bold my-2"><?php echo $row['house_type']?></p>
                        </div>
                        </a> 
