        ...
        <div class="container marketing">
                ...
                <div class="px-4 my-5 text-center">
                    <div class="col-lg-12 mx-auto">
                        ...
                        <p class="lead mb-4 hover"><br>
                        At NOVA, we make finding rental homes easier and more accessible for everyone. Our platform is dedicated to helping people discover their next home—whether it’s a cozy single-family house, a modern apartment, or a comfortable condo—without unnecessary hassles. We believe in simplifying the process by allowing users to explore property options without needing to log in. With just a few clicks, users can see essential details and a primary image of available properties. If a property sparks interest, filling out a quick contact form connects users directly to our team. From there, we handle the next steps, including payment and other processes, making it convenient for renters and landlords alike. Our mission is to bridge the gap between potential renters and quality housing, making every step seamless, transparent, and efficient. At [Your App Name], finding a place to call home has never been easier.
                        </p>
<br>
<div class="h4">In case you want to give us a comment/ message</div>
<br>
        <div class="col-10 ms-5 justify-items-center">
        <div class="row featurette">     
                    <div class="row">
                      <form class="col-12" method="POST" action="../server/sendcomment.php">
                        <div class="row">
                            <div class="col-6">                                
                           ...
                           <div class="col-6">
                            <label>Comment</label>
                             ...
                             <br>
                             <button type="submit" class="" title="Send Now">SEND</button>
                           </div>
                        </div>
                      </form>
                    </div>
