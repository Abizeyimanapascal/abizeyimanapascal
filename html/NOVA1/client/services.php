                    ...
                    <div class="row g-4 py-5 row-cols-1 row-cols-lg-6">
                        <div class="feature col">
                            <div
                                ...
                                <img src="img/s1.jpg" class="rounded" height="100px" width="60%" alt="">
                            </div>
                            <p class="hover">
                            <h6 class="text-dark">Property Browsing</h6>
                            Users can browse a variety of rental options, including single-family homes, apartments, and condos, with essential information and images provided upfront
                            </p>
                        </div>
                        <div class="feature col">
                            <div
                                class="feature-icon d-inline-flex align-items-center justify-content-center col-12 fs-2 mb-3">
                                <img src="img/s2.png" class="rounded" height="100px" width="60%" alt="">
                            </div>
                            <p class="hover">
                            <h6 class="text-dark">Advanced Property Search</h6>
                            Filters for location, price range, property type, and amenities allow users to find their ideal rental based on specific needs and preferences.
                            </p>
                        </div>
                        <div class="feature col">
                            <div
                                class="feature-icon d-inline-flex align-items-center justify-content-center col-12 fs-2 mb-3">
                                <img src="img/s3.png" class="rounded" height="100px" width="60%" alt="">
                            </div>
                            <p class="hover">
                            <h6 class="text-dark">Instant Inquiry Form</h6>
                            Interested users can quickly fill out a contact form to connect with your team for more details or to schedule a visit..
                            </p>
                        </div>
                        <div class="feature col">
                            <div
                                class="feature-icon d-inline-flex align-items-center justify-content-center col-12 fs-2 mb-3">
                                <img src="img/s4.jpg" class="rounded" height="100px" width="60%" alt="">
                            </div>
                            <p class="hover">
                            <h6 class="text-dark">Customized Recommendations</h6>
                            Personalized property suggestions based on user preferences help streamline the search process.
                            </p>
                        </div>
                        <div class="feature col">
                            <div
                                class="feature-icon d-inline-flex align-items-center justify-content-center col-12 fs-2 mb-3">
                                <img src="img/s5.png" class="rounded" height="100px" width="60%" alt="">
                            </div>
                            <p class="hover">
                            <h6 class="text-dark">Verified Property Listings</h6>
                            Ensures all listed rentals meet quality and authenticity standards, giving users confidence in each option.
                            </p>
                        </div>
                        <div class="feature col">
                            <div
                                class="feature-icon d-inline-flex align-items-center justify-content-center col-12 fs-2 mb-3">
                                <img src="img/s6.png" class="rounded" height="100px" width="60%" alt="">
                            </div>
                            <p class="hover">
                            <h6 class="text-dark">Guided Rental Process</h6>
                            After initial contact, users receive step-by-step support through negotiations, payment, and finalizing lease agreements, ensuring a smooth rental experience.
                            </p>
                        </div>
