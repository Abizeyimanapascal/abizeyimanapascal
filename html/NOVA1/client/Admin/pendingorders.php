    ...
    <div class="text-center fixed-top row bg-light text-muted shadow"  style="transition:transform 3s ease-in;">
      ...
      <div class="container-fluid">
        ...
        <ul class="navbar-nav me-auto mb-2 mb-md-0 justify-content-center">              
            <li class="nav-item">      
            <a class="btn btn-outline-warning py-4 ms-5" href="waitinguploads.php">Waiting Uploads 
              <div class="badge bg-light text-warning"><?php echo $row; ?></div>
            </a>
            </li> 
            <li class="nav-item">
              <a class="btn btn-outline-success py-4 ms-5" href="availablehouse.php">Available Houses
              <div class="badge bg-light text-success"><?php echo $row1; ?></div>
              </a>
            </li>
            <li class="nav-item">
              <a class="btn btn-secondary py-4 ms-5" href="pendingorders.php">Inquiries
              <div class="badge bg-light text-secondary"><?php echo $row3; ?></div>
              </a>
            </li>
            <li class="nav-item">
              <a class="btn btn-outline-info py-4 ms-5" href="messages.php">Messages
...
<br><br><br>
  ...
  ================================================== -->
    ...
    <br><br><br><br>
      <!-- MAIN US ROW -->
      <div class="row">
      <div class="alert bg-secondary h6 row">
           <div class="col-1">Inqury ID</div>
           <div class="col-1">House ID</div>
        ...
        ?>  
          <div class="alert alert-light text-muted row">
           <div class="col-1"><?php echo $row['oid'] ?></div>
           <div class="col-1"><?php echo $row['house_id'] ?></div>
           <div class="col-3"><?php echo $row['client_name'] ?></div>
           <div class="col-3"><?php echo $row['client_email'] ?></div>
           <div class="col-1"><?php echo $row['client_phone'] ?></div>
           <div class="col-2"><?php echo $row['orderdate'] ?></div>
           <div class="col-1 text-danger">
           <a href="../../server/deleteinquiry.php? id=<?php echo $row['oid'] ?>" class="link text-danger" style="text-decoration:none;">Delete</a>
           </div>
          </div>
         <?php
         }
