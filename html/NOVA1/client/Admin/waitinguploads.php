    ...
    <div class="text-center fixed-top row bg-light text-muted shadow"  style="transition:transform 3s ease-in;">
      ...
      <div class="container-fluid">
        ...
        <ul class="navbar-nav me-auto mb-2 mb-md-0 justify-content-center">              
            <li class="nav-item">      
            <a class="btn btn-warning py-4 ms-5" href="waitinguploads.php">Waiting Uploads 
            ...
            <li class="nav-item">
              <a class="btn btn-outline-secondary py-4 ms-5" href="pendingorders.php">Inquiries
...
<br><br><br>
  ...
  ================================================== -->
    ...
    <br><br><br><br>
      <!-- MAIN US ROW -->
      <div class="row">
      <div class="alert bg-warning h6 row">
           <div class="col-1">House</div>
        ...
        ?>  
          <div class="alert alert-light text-muted row">
           <div class="col-1"><img src="../feather/home.svg"></div>
           ...
           <div class="col-1"><?php echo $row['num_beds'] ?></div>
           <div class="col-3"><?php echo $row['ownername'] ?></div>
           <div class="col-1"><?php echo $row['ownerphone'] ?></div>
           <div class="col-1 text-danger">
            <a href="../../server/admindeletehouse.php? id=<?php echo $row['house_id'] ?>" class="link text-danger ms-2" style="text-decoration:none;">❌</a>
            <a href="../../server/approve.php? id=<?php echo $row['house_id'] ?>" class="link text-success ms-2" style="text-decoration:none;">✅</a>
           </div>
