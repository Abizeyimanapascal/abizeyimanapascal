...
<head>
    ...
    <title>UTAB</title>
    <link rel="icon" type="image/png" href="{{ asset('img/utab_logo.png') }}">
    ...
    <link rel="stylesheet" href="{{ asset('css/carousel1.css') }}">
...
<body>
    ...
    <header data-bs-theme="bg-light">
        <div class="text-center sticky-top row bg-light shadow" style="transition:transform 3s ease-in;font-family: 'Poppins', Helvetica, Arial, Lucida, sans-serif;border-bottom:4px solid #2ea3f2">
            <div class="col-2 h3">
              <a class="nav-link text-primary mt-2" href="index.php"><img src="{{ asset('img/logo.png') }}"width="100px" height="30px"></a>
            </div>
            ...
            <div class="col-2"><a class="m-2 btn text-light" data-bs-toggle="offcanvas"
                    data-bs-target="#signinoffcanvas" aria-controls="offcanvasScrolling" style="background: #2ea3f2"><b>Sing in</b></a>
            </div>
        </div>
        ...
        <div id="myCarousel" class="carousel slide mb-6" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <img src="{{ asset('img/utab1.jpg') }}" alt="" style="width: 100%;height: 100%;">
                    <div class="container">
                        <div class="carousel-caption center-start">
                            <h1 class="pic1an1">UTAB HR</h1>
                            <p class="top-5 pic1an2 text-light h1">Request for leave or a day off</p>
                            <p><a class="btn btn-lg btn-primary" href="uploadhouse.php">Request Now</a>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                <img src="{{ asset('img/utab2.jpeg') }}" alt="" style="width: 100%;height: 100%;">
                    <div class="container">
                        <div class="carousel-caption">
                            <h1 class="pic2an1 top-5">Track your leave and day off status</h1>
                            <p class=" top-5">Track your leave and day off status</p>
                            <p><img src="{{ asset('img/communication.png') }}" alt="" width="150"></p>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                <img src="{{ asset('img/utab3.jpg') }}" alt="" style="width: 100%;height: 100%;">
                    <div class="container">
                        <div class="carousel-caption text-center">
                            <h1 class="pic3an1">Guided Requesting Process</h1>
                            <p class="pic3an2">Staff make direct contact with HR</p>
                            <p><img src="{{ asset('img/utab3.png') }}" alt="" width="150"></p>
                        </div>
                    </div>
                </div>
            </div>
           ...
           <a name="loginsection"></a>
            ...
            <div class="tab-content row" id="nav-tabContent">
                <div class="col-md-3 text-muted">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam culpa quidem corporis quas expedita, modi voluptatibus voluptate, magni itaque, officiis rerum at consectetur veniam doloremque fuga! Facilis laborum officia inventore!
                </div>
                ...
                <div class="tab-pane fade show active col-md-6" id="nav-staff" role="tabpanel" aria-labelledby="nav-home-tab">
                    <form class="needs-validation" method="POST" action="index.php" novalidate>
                        <div class="form-floating">
                            ...
                            <label for="floatingUsername" class="text-muted"><img src="{{ asset('feather/user.svg') }}"> Username</label>
                        ...
                        <div class="form-floating">
                            ...
                            <label for="floatingPassword" class="text-muted"><img src="{{ asset('feather/lock.svg') }}"> Password</label>
                            <div class="invalid-feedback">
