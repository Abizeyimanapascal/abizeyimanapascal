  ...
  <main class="text-muted">
       ...
       ================================================== -->
        ...
        <div class="container marketing">
            ...
            <!-- ABOUT US ROW -->
            <div class="row">
                <div class="alert text-center">Lorem ipsum dolor sit amet consectetur adipisicing elit. Amet totam,
                        ...
                        <tr>
                            ...
                            <td><?php echo $row['address'] ?></td>
                              <?php if ($row['orderstatus'] == 'accepted') {
                                ...
                                echo "<td><button style='border:none;'><a href='../server/acceptorder.php?id=$row[oid]' class='text-danger' style='text-decoration:none;' onclick=\"return confirm('Do you really ACCEPT this order?');\">🔵</a></button></td>";
                                echo "<td><button style='border:none;'><a href='../server/scancelorder.php? id=$row[oid]' class='text-danger' style='text-decoration:none;' onclick=\"return confirm('Do you really DENY this order?');\">🔴</a></button></td>";
                              }
                              ?>
                        </tr>
