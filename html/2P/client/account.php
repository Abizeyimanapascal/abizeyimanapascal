  ...
  ================================================== -->
    ...
    <div class="px-4 my-5 text-center">
        <div class="col-lg-6 mx-auto">
          ...
          <button type="submit" name="payticket" class="btn border">
      ...
      <?php
      $sql = "SELECT * FROM `product` WHERE `status` = 'approved' AND (`productname` LIKE '%$_REQUEST[search]%' OR `productdescription` LIKE '%$_REQUEST[search]%') ORDER BY `uploaddate` DESC";
      ...
      <div class="card-body">
         ...
         <a href="checkout/index.php? pid=<?php echo $row['pid'] ?>" class="btn btn-primary">Order Now</a>
      </div>
      </div> 
