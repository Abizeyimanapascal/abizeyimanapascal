  ...
  <div class="row">
    <div class="sidebar position-fixed border-right col-md-3 col-lg-2 p-0 pb-5 pt-3 bg-primary">
      <div class="offcanvas-md offcanvas-end bg-primary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2 text-primary" id="postbtn" style="background:white;">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2 text-primary">Post something</h1>
      </div>

              <div class="row post" style="display:block">
