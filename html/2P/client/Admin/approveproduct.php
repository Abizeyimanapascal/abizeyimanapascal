  ...
  <div class="row">
    <div class="sidebar position-fixed border-right col-md-3 col-lg-2 p-0 pb-5 pt-3 bg-primary">
      <div class="offcanvas-md offcanvas-end bg-primary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2 text-primary" id="approveproductbtn"  style="background:white;">
            ...
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2" id="messagesbtn">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2 text-primary">Unapproved Products</h1>
      </div>

      <div class="row approveproduct">
                <div class="alert alert-warning text-muted">Lorem ipsum dolor sit amet consectetur adipisicing elit. Amet totam,
                    optio natus sapiente excepturi sit, aspernatur delectus numquam velit nihil sint magnam. Amet a
                    consequuntur ex enim architecto suscipit minus?</div>
                    ...
                    <tbody>
                      <?php
                        $sql = "SELECT * FROM `product` WHERE `status` = 'not approved'";
                        ...
                        <tr>
                            ...
                            <td><button style="border:none;"><a href="../../server/approve.php? id=<?php echo $row['pid'] ?>" class="text-danger" style="text-decoration:none;" onclick="return confirm('Do you really APPROVE this Product?');">✅</a></button></td>
                        </tr>
...
<script src="../assets/dist/js/bootstrap.bundle.min.js"></script>
    ...
    <script>
      document.getElementById("dashboardbtn").addEventListener("click", function () {
            document.querySelector(".approveproduct").style.display = "none";
