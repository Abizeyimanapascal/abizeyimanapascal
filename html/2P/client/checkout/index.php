            ...
            <div class="row g-5">
                ...
                <div class="col-md-7 col-lg-8">
                    ...
                    <form class="needs-validation" method="POST" novalidate>
                        ...
                        <input name="checkoutbtn" class="w-100 btn btn-primary btn-lg" type="submit" value="Confirm Order">
                        <?php
                          if(isset($_POST['checkoutbtn'])){
                            ...
                            if ($ORDERQUANTITY > $productrow['productquantity']) {
                                ...
                                $sql = "INSERT INTO `order` (`oid`, `pid`, `username`, `owner`, `orderquantity`)
                                 VALUES (
                                 NULL,
                                 '$productrow[pid]',
                                 '$userrow[username]',
                                ...
                                echo "<script>alert('Upload FAILED !');window.location='index.php';</script>";
                               }
                            }
                          }
                        ?>
