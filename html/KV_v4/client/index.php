        ...
        <div class="carousel-item active">
          ...
          <div class="container">
            <div class="carousel-caption text-start">
              ...
              href="#bookyourticketnowmodal" style="background:#171a97db;">Book now</a></p>
            </div>
          </div>
        </div>
...
<a name="aboutus">
        ...
        <div class="col-lg-12 mx-auto">
          ...
          <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
            <button type="button" class="btn btn-success btn-lg px-5 p-3 text-warning hover" aria-current="page" data-bs-toggle="modal"
              data-bs-target="#bookyourticketnowmodal">Secure Your Seat Now!</button>
          </div>
        </div>
      </div>
      <!-- /.row  -->
      ...
      <div class="container px-4" id="featured-3">
        <div class="row">
          <div class="feature h1 text-muted col-12 border-bottom text-center p-3 momo"
            ...
            <b>Travel with us, Experience comfort and safe journey</b>
          </div>
        </div>
      </div>
      <!--  /.row  -->
  ...
  <a name="staff">
      ...
      <div class="row py-5">
        <div class="col-lg-4">
          <img src="img/vv1.jpg" alt="" height="150" class="rounded-circle">
        ...
        <div class="col-lg-4">
        <img src="img/vv2.jpg" alt="" height="150" class="rounded-circle">
        ...
        <div class="col-lg-4">
        <img src="img/vv3.jpeg" alt="" height="150" class="rounded-circle">
      ...
      <div class="row featurette">
        <div class="col-md-7">
          <h4 class="featurette-heading hover text-center">And here,reach out to us. <span
              class="text-body-success">Our contacts.</span></h4>
          <div class="row">
              <div class="col-6">
                <p class="lead hover"> <span class="text-success"> <b>Here we are</b> </span><br>
                <b>Virunga Busines Groupe <br>
                P.O.Box: 121 Musanze <br>
                Rwanda <br>
                Whatsapp/Call:</b> 250791234567
               </p>
              </div>
              <div class="col-6">
        ...
        <div class="modal-body justify-items-center">
          ...
          <div class="row">
            <div class="col-md-5 p-5 shadow-lg" style="">
              <div class="text-center text-danger">AVAILABLE ROUTES AND DESTINATIONS</div><br>
              <table border="1" width="100%">
                <tr style="border:1px solid black"><td><div type="button" id="route1" onclick="route1click()" class="text-center route" style="opacity: 0.6;">Kigali - Rubavu 1000 RWF</div></td></tr>
                <tr style="border:1px solid black"><td><div type="button" id="route2" onclick="route2click()" class="text-center route" style="opacity: 0.8;">Kigali - Gicumbi 1000 RWF</div></td></tr>
                <tr style="border:1px solid black"><td><div type="button" id="route3" onclick="route3click()" class="text-center route" style="opacity: 0.8;">Kigali - Musanze 1700 RWF</div></td></tr>
                <tr style="border:1px solid black"><td><div type="button" id="route4" onclick="route4click()" class="text-center route" style="opacity: 0.8;">Rubavu - Kigali 3000 RWF</div></td></tr>
                <tr style="border:1px solid black"><td><div type="button" id="route5" onclick="route5click()" class="text-center route" style="opacity: 0.8;">Gicumbi - Kigali 1000 RWF</div></td></tr>
                <tr style="border:1px solid black"><td><div type="button" id="route6" onclick="route6click()" class="text-center route" style="opacity: 0.8;">Musanze - Kigali 1700 RWF</div></td></tr>
                <tr style="border:1px solid black"><td><div type="button" id="route7" onclick="route7click()" class="text-center route" style="opacity: 0.8;">Musanze - Rubavu 1100 RWF</div></td></tr>
                <tr style="border:1px solid black"><td><div type="button" id="route8" onclick="route8click()" class="text-center route" style="opacity: 0.8;">Rubavu - Musanze 1100 RWF</div></td></tr>
                <tr style="border:1px solid black"><td><div type="button" id="route9" onclick="route9click()" class="text-center route" style="opacity: 0.8;">Rubavu - Byangabo 900 RWF</div></td></tr>
                <tr style="border:1px solid black"><td><div type="button" id="route10" onclick="route10click()" class="text-center route" style="opacity: 0.8;">Rubavu - Mukamira 1200 RWF</div></td></tr>
                <tr style="border:1px solid black"><td><div type="button" id="route11" onclick="route11click()" class="text-center route" style="opacity: 0.8;">Rubavu - Mahoko 1300 RWF</div></td></tr>
                <tr style="border:1px solid black"><td><div type="button" id="route12" onclick="route12click()" class="text-center route" style="opacity: 0.8;">Musanze - Gakenke 1700 RWF</div></td></tr>
                <tr style="border:1px solid black"><td><div type="button" id="route13" onclick="route13click()" class="text-center route" style="opacity: 0.8;">Musanze - Mukoto 1500 RWF</div></td></tr>
                <tr style="border:1px solid black"><td><div type="button" id="route14" onclick="route14click()" class="text-center route" style="opacity: 0.8;">Byangabo - Kabari 1000 RWF</div></td></tr>
                <tr style="border:1px solid black"><td><div type="button" id="route15" onclick="route15click()" class="text-center route" style="opacity: 0.8;">Mukoto - Base 1000 RWF</div></td></tr>
                <tr style="border:1px solid black"><td><div type="button" id="route16" onclick="route16click()" class="text-center route" style="opacity: 0.8;">Kigali - Base 2000 RWF</div></td></tr>
              </table>
            ...
            <div class="col-md-7 p-5">
                ...
                <div class="col-md-12 mt-2">
                  ...
                  <input type="number" name="phone" id="telephonenofield" class="form-control" required/>
                  <div class="invalid-feedback">
  ...
  <div class="offcanvas-body">
    <form method="POST" action="../server/login.php">
      ...
      <div class="">
        ...
        <select name="busstation" class="form-control" required>
          <option></option>
          <option value="Kigali Bus station">Kigali Bus station</option>
          <option value="Gicumbi Bus station">Gicumbi Bus station</option>
          <option value="Musanze Bus station">Musanze Bus station</option>
          <option value="Rubavu Bus station">Rubavu Bus station</option>
...
function route9click() {
  document.querySelectorAll('.route').forEach((element) => {
        element.style.backgroundColor = '';
        element.style.color = '';
    });
  document.getElementById('route9').style.backgroundColor ='green';
  document.getElementById('route9').style.color ='white';
  document.getElementById('routefield').value ='Rubavu - Byangabo';
  document.getElementById('pricefield').value ='900'; 
}
function route10click() {
  document.querySelectorAll('.route').forEach((element) => {
        element.style.backgroundColor = '';
        element.style.color = '';
    });
  document.getElementById('route10').style.backgroundColor ='green';
  document.getElementById('route10').style.color ='white';
  document.getElementById('routefield').value ='Rubavu - Mukamira';
  document.getElementById('pricefield').value ='1200'; 
}
function route11click() {
  document.querySelectorAll('.route').forEach((element) => {
        element.style.backgroundColor = '';
        element.style.color = '';
    });
  document.getElementById('route11').style.backgroundColor ='green';
  document.getElementById('route11').style.color ='white';
  document.getElementById('routefield').value ='Rubavu - Mahoko';
  document.getElementById('pricefield').value ='1300'; 
}
function route12click() {
  document.querySelectorAll('.route').forEach((element) => {
        element.style.backgroundColor = '';
        element.style.color = '';
    });
  document.getElementById('route12').style.backgroundColor ='green';
  document.getElementById('route12').style.color ='white';
  document.getElementById('routefield').value ='Musanze - Gakenke';
  document.getElementById('pricefield').value ='1700'; 
}
function route13click() {
  document.querySelectorAll('.route').forEach((element) => {
        element.style.backgroundColor = '';
        element.style.color = '';
    });
  document.getElementById('route13').style.backgroundColor ='green';
  document.getElementById('route13').style.color ='white';
  document.getElementById('routefield').value ='Musanze - Mukoto';
  document.getElementById('pricefield').value ='1500'; 
}
function route14click() {
  document.querySelectorAll('.route').forEach((element) => {
        element.style.backgroundColor = '';
        element.style.color = '';
    });
  document.getElementById('route14').style.backgroundColor ='green';
  document.getElementById('route14').style.color ='white';
  document.getElementById('routefield').value ='Byangabo - Kabari';
  document.getElementById('pricefield').value ='1000'; 
}
function route15click() {
  document.querySelectorAll('.route').forEach((element) => {
        element.style.backgroundColor = '';
        element.style.color = '';
    });
  document.getElementById('route15').style.backgroundColor ='green';
  document.getElementById('route15').style.color ='white';
  document.getElementById('routefield').value ='Mukoto - Base';
  document.getElementById('pricefield').value ='1000'; 
}
function route16click() {
  document.querySelectorAll('.route').forEach((element) => {
        element.style.backgroundColor = '';
        element.style.color = '';
    });
  document.getElementById('route16').style.backgroundColor ='green';
  document.getElementById('route16').style.color ='white';
  document.getElementById('routefield').value ='Kigali - Base';
  document.getElementById('pricefield').value ='2000'; 
}
...
function submitticket() {
  ...
  const amout=document.getElementById('pricedetails').innerHTML;
  let phone=document.getElementById('telephonenodetails').innerHTML;
  gettoken(amout,phone);
  console.log("Amout is",amout)
}
async function gettoken(amout,phone) 
{

  

  console.log("Form submitted, processing payment...");  // Debug log
...
try {
    ...
    const response = await fetch(`https://payments.paypack.rw/api/auth/agents/authorize`, {
        ...
        body: JSON.stringify({
            client_id: "00534016-6550-11ef-82cb-deade826d28d",
            client_secret: "8fc7f809dd1306f59df0cf6a3feb828ada39a3ee5e6b4b0d3255bfef95601890afd80709"
        })
    });
    ...
    if (response.ok) {
        console.log("Payment authorized:", responseJson);
        // console.log(responseJson.access)
        const access_key=responseJson.access;
        requesttopay(access_key,phone,amout);
       
        return true;  // Allow form submission if successful
    } else {
...
return false;  // Prevent form submission if error occurs
}
async function requesttopay(access,phone,amout) 
        {
          
            try {
              let amouts=parseFloat(amout);
                ...
                const responseJson=await response.json();
                if (response.ok) {
                    console.log("Payement Result:",amout,phone,responseJson);
                    // Swal.fire({
                    //     icon: 'success',
                    //     title: 'Payment Pending',
                    //     text: 'Please confirm Payement of use *182*7*1# and Confirm.Thank You'
                    // });
                    // const refrence=responseJson.ref
                    // checkTransactionStatus(access,phoneNumber,refrence);
