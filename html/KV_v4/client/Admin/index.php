...
<body>
    ...
    <div class="container marketing">
      ...
      <div class="px-4 py-5 my-5 text-center border-bottom">
        <div class="alert alert-info">
          ...
          $welcome = '';
          if ($getbusstation == 'Kigali Bus station') {
            $welcome = 'Welcome <b>'.$getbusstation.' Manager !</b> Now you can only access and manage all VIRUNGA travels records of your Bus station.';
          }
          else if ($getbusstation == 'Gicumbi Bus station') {
            $welcome = 'Welcome <b>'.$getbusstation.' Manager !</b> Now you can only access and manage all VIRUNGA travels records of your Bus station.';
          }
            ...
            $welcome = 'Welcome <b>'.$getbusstation.' !</b> Now you can access and manage all VIRUNGA travels.';
          }
          echo $welcome;
          ?>
        </div>
        ...
        <div class="col-lg-12 mx-auto">
            <div class="row">
              ...
              <a class="nav-link bg-success col m-2 p-4 rounded text-light hover" href="search.php?search&busstation=<?php echo $getbusstation ?>">Report</a>
            </div>
                ...
                <div class="col-9">
                  <table class="table table-sm table-hover table-bordered">
                    ...
                    <?php
                      ...
                      $sql = "SELECT * FROM routes WHERE `from` LIKE '%$busstation%'";
  ...
  <script>
    document.getElementById("searchbtn").AddEventListener(click, () => {
       document.querySelector("defaultsearch").style.display = "none";
    });
  </script>
