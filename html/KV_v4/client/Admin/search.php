...
$getbusstation = $_GET['busstation'];
$busstation = '';
if ($getbusstation == 'Kigali Bus station') {
  $busstation = 'kigali';
}
else if ($getbusstation == 'Gicumbi Bus station') {
  $busstation = 'gicumbi';
}
else if ($getbusstation == 'Musanze Bus station') {
  $busstation = 'musanze';
}
else if ($getbusstation == 'Rubavu Bus station') {
  $busstation = 'rubavu';
}
else {
  $busstation = '';
...
<body>
  ...
  <div class="p-2 text-center sticky-top row bg-success" style="transition:transform 3s ease-in;">
      <div class="col-2 "><img src="img/vlog.png" alt="" style="width: 80px;height: 80px;border-radius: 50%;"></div>
      <div class="col-6 p-3 h1 ">VIRUNGA <span class="text-light">Express</span></div>
      <div class="col-2 mt-4"><b><?php echo $getbusstation ?></b></div>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse text-center" id="navbarCollapse">
          <ul class="navbar-nav me-auto mb-2 mb-md-0">
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="index.php?busstation=<?php echo $getbusstation ?>">Dashboard📊</a>
            <!-- </li>
            ...
            <li class="nav-item">
            <a class="nav-link" href="search.php?search&busstation=<?php echo $getbusstation ?>">Report</a>
            </li>
          </ul>
        </div>
      </div>
  ...
  ================================================== -->
    ...
    <div class="container marketing">
              ...
              <div class="px-4 py-5 my-5 border-bottom row">
                ...
                <div class="col-9">
                  <table class="table table-sm table-hover table-bordered">
                    ...
                    <?php
                      include "../../server/connection.php";
                      $sql = "SELECT * FROM reservedtickets WHERE `route` LIKE '$busstation%'";
                      $query = mysqli_query($con, $sql)or die(mysqli_error());
                      while ($row = mysqli_fetch_array($query, MYSQLI_ASSOC)){
                        ?>
      ...
      <!-- REPORT ROW -->
              <div class="px-4 py-5 my-2 border-bottom row">
                <div class="col-3"><img src="img/vlog.png" alt="" class="sticky-top" width="60%" height="80px"></div>
                <div class="col-9">
                  <b class="h2">Search by Time To Travel</b>
                  <!-- SEARCH  ROW -->
                  <div class="px-4 my-1 text-center">
                    <div class="col-lg-6 mx-auto">
                       <form action="search.php?">
                         <div class="input-group mb-3">
                         <select name="search" class="form-control" id="traveltimefield">
                           <option></option>
                         </select>
                         <input type="text" name="busstation" value="<?php echo $getbusstation ?>" hidden>
                            <button type="submit" name="" class="btn border">
                              <img src="../img/searchicon.png" width="20">
                            </button>
                         </div>
                        </form>
                    </div>
                ...
                <div class="searchreport">
                  <table class="table table-sm table-hover table-bordered" id="contentToPrint">
                    <thead>
                      <tr>
                        <th scope="col">Route</th>
                        <th scope="col">Passenger</th>
                    ...
                    <?php
                      include "../../server/connection.php";
                      $sql = "SELECT * FROM reservedtickets WHERE `route` LIKE '$busstation%' AND `traveltime` LIKE '%$_GET[search]%'";
                      $query = mysqli_query($con, $sql)or die(mysqli_error());
                      $countsearch = mysqli_num_rows($query);
                      while ($row = mysqli_fetch_array($query, MYSQLI_ASSOC)){
                        ?>
                      ...
                      <?php
                       ...
                       echo  "<b>$countsearch</b> Rows Matching from database<br><br>";
                       mysqli_close($con);
      
                       ?>
                       <button onclick="printDivContent('contentToPrint')">Print Report</button>
                    </tbody>
                  </table>
                </div>
              </div>
